...
const Filter = ({ categories = [] }) => {
  ...
  useEffect(() => {
    ...
    const currentSortOrder = searchParams.get("sortOrder") || searchParams.get("sortby") || "asc";
  ...
  useEffect(() => {
    const handler = setTimeout(() => {
      ...
      if (searchTerm && searchTerm.trim().length > 0) next.set("keyword", searchTerm.trim());
  ...
  const handleCategoryChange = (event) => {
    ...
    else next.set("category", String(selectedCategory)); 
    next.delete("page");
