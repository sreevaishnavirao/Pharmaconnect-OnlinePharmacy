...
const Sidebar = ({ isProfileLayout = false }) => {
  ...
  return (
    ...
    <div className="h-full mt-16 flex flex-col gap-y-7 overflow-hidden bg-teal-900 px-6 pb-4">
    
      <div className="flex h-16 shrink-0 items-center gap-x-3 pt-2">
        <FaTachometerAlt className="h-8 w-8 text-teal-400" />
